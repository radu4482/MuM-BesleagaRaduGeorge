...
<input type="text" name ="artist_name" placeholder="Artist name"></input>
<input type="text" name = "artist_music_type" placeholder="Music Gender"></input>
...
<input type="text" name ="update_artist_name" placeholder="Artist name"></input>
<input type="text" name = "update_artist_music_type" placeholder="Music Gender"></input>
...
<input type="text" name ="delete_artist_name" placeholder="Artist"></input>
